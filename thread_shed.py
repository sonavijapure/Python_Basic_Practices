...
#------------------------------------------------
# Start coding below!
#Replace all the instances of ;,; in daily_sales with :
daily_sales_replaced = daily_sales.replace(";,;", ":")

# split the  daily sales string into a list of each individual transaction

daily_transactions = daily_sales_replaced.split(",")

#splitting  each individual transaction
daily_transactions_split = []
for transac in daily_transactions:
  daily_transactions_split.append(transac.split(":"))

#cleaned up transactions to the new list
transactions_clean = []
...
#appending respective value to the list
...
#count for how many times a color is present in list thread_sold_split
...
#for loop to  print a sentence that says how many threads of each color were sold today.
for i in colors:
  print("{color} sold {cnt} times".format(color = i, cnt = color_count(i)))
